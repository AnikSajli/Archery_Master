...
public class Game extends JFrame implements ActionListener{
    ...
    JButton playBtn,creditBtn,highscoreBtn,quitBtn,backBtn0,backBtn1,backBtn2,lvl1,lvl2,lvl3,backBtn;
    public enum GameState{NEW,NEW2, CONTINUE,CONTINUE2, CONTINUE3, OVER, OVER2, OVER3, HIGHSCORE, CREDITS, WAIT, QUIT, LEVEL1, LEVEL2, LEVEL3  };
    ...
    public void setMenuPanel()
    {
        ...
        lvl1.setBounds(200, 213, 310, 85);
        lvl2.setBounds(475,213,330,85);
        lvl3.setBounds(775,213,330,85);
    ...
    public void setHighScorePanel() throws IOException
    {
        ...
        defaultFont = new Font("Ubuntu",Font.BOLD,72);
