...
public class GameBoard2 extends JPanel implements ActionListener{
                                                ...
                                                ///Initialization.
    JPanel gameover;
    private final String fileBackground = "images/background/bg-2.jpg";
    ...
    String bow0="images/BowArrows/bow 0.png",
            ...
            BackGroundFile="images/background/bg-2.jpg";
    String arrowshoot = "images/BowArrows/Black_Circle.png";
    String avatar_1="images/avatars/man-1.png";
    String aim_1 = "images/avatars/watermelon1.png";
    String aim_sad_1 = "images/avatars/watermelon2(sad).png";
    ...
    public void gameLoop(){
        mainTimer = new Timer(Game.REFRESH_TIME, new ActionListener() {			
            ...
            public void actionPerformed(ActionEvent arg0) {
                ...
                {
                    mainTimer.stop();
                    Game.setState(Game.GameState.OVER2);
                    return;
                }
            }
        });
    ...
    public void paint(Graphics g) {
            ...
            g2d.drawImage(aim1, 1095+10,350+9, null);
    ...
    {
        Graphics2D g2 = (Graphics2D) g;
        g2.drawImage(aim1sad, 1095-5,320+18, null);
    ...
    {
        if((arrow_x+2)>=1105 && (arrow_x+2)<=1150 && (arrow_y+1)>=360 && (arrow_y+1)<=403)
            shooted = true;
    }
    ...
    public void gameOver() {
        ...
        case JOptionPane.YES_OPTION:
                Game.setState(Game.GameState.CONTINUE2);
                break;
