...
public class GameBoard3 extends JPanel implements ActionListener{
    
                                                ///Initialization.
    JPanel gameover;
    private final String fileBackground = "images/background/bg-4.jpeg";
    ...
    String bow0="images/BowArrows/bow 0_white.png",
            bow1="images/BowArrows/bow 1_white.png",
            BackGroundFile="images/background/bg-4.jpeg";
          
    String arrowshoot = "images/BowArrows/White_Circle.png";
    String avatar_1="images/avatars/man-1.png";
    String aim_1 = "images/avatars/happy_apple1.png";
    String aim_sad_1 = "images/avatars/angry_apple1.png";
    String Arrow = "images/BowArrows/arrow_1_White.png";
    ...
    public void gameLoop(){
        mainTimer = new Timer(Game.REFRESH_TIME, new ActionListener() {			
            ...
            public void actionPerformed(ActionEvent arg0) {
                ...
                {
                    mainTimer.stop();
                    Game.setState(Game.GameState.OVER3);
                    return;
                }
            }
        });
    ...
    public void paint(Graphics g) {
            ...
            g2d.drawImage(aim1, 1095+12,350+15, null);
    ...
    {
        Graphics2D g2 = (Graphics2D) g;
        g2.drawImage(aim1sad, 1095+5,350+2, null);
    ...
    public void speed_draw(Graphics g)
    {
        ...
        Font f= new Font(Font.SERIF, Font.BOLD, 30);
        g2d.setFont(f);
        g2d.drawString("Speed: "+speed+" fps",20,130);
    }
    ...
    {
        if((arrow_x+2)>=1112 && (arrow_x+2)<=1165 && (arrow_y+1)>=372 && (arrow_y+1)<=405)
            shooted = true;
    }
    ...
    public void gameOver() {
        ...
        case JOptionPane.YES_OPTION:
                Game.setState(Game.GameState.CONTINUE3);
                break;
